...
def fishJibIntro():
    addAndWriteMessage(
        "FishJib123", "Hey, are you new to this platform?")
    addAndWriteMessage(username, "Yeah, I am")
    addAndWriteMessage(
        "FishJib123", "Wow, I cannot believe this really works. This is really revolutionary")
    addAndWriteMessage(username, "Eh, it's not that impressive")
    addAndWriteMessage(
        "FishJib123", "Anyway, I can't believe it's almost the year 2000!")
...
def learnAboutFishJib():
    ...
    getJimmyInfo = True
    addAndWriteMessage(
        "FishJib123", "My name is Jimmy. What about you?")
...
def almost2000():
    ...
    addAndWriteMessage(
        "FishJib123", "Yes? Why do you keep bringing this up?")
    addAndWriteMessage(
        "FishJib123", "It's 1999. Everybody knows this!")
...
def saveJimmy():
    ...
    addAndWriteMessage(
        username, "In July of 2000, Chicago experiences a deadly heat wave and hundreds of people die")
    addAndWriteMessage(
        username, "if you're not joking your current year, just be wary about that")
    addAndWriteMessage("FishJib123",
